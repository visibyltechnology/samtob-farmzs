      ...
      <div className="container">
          ...
          <div className="footer-brand">
            ...
            <div className="contact-info">
              ...
              <div className="contact-item">
                ...
                <a href="https://chat.whatsapp.com/IusfVtpSpkQ96S8tHFJgmK" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit' }}>
                  Join WhatsApp Group
                </a>
              </div>
            </div>
        ...
        <div className="footer-bottom-row">
          <div className="footer-socials">
            <a href="https://chat.whatsapp.com/IusfVtpSpkQ96S8tHFJgmK" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Group" className="social-btn social-btn--whatsapp">
