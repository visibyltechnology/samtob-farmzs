...
export default function Shop() {
  ...
  // Map URL slugs to chicken product categories
  const SLUG_MAP = {
    live: 'Live Chicken',
  ...
  return (
    <main className="main-content" id="main">
      ...
      <div className="shop-page-header">
        <h1>Shop Fresh <span className="title-accent">Chickens</span></h1>
          ...
          <div className={`product-grid shop-product-grid ${view === 'list' ? 'shop-product-grid--list' : ''}`}>
            {loading ? (
              ...
              <div style={{ gridColumn: '1 / -1', padding: '60px', textAlign: 'center', color: 'var(--gray-1)' }}>
                ...
                <p style={{ fontWeight: 700, fontSize: '1.1rem' }}>No chickens found</p>
                <p style={{ fontSize: '13px', marginTop: '4px' }}>Try adjusting your filters or browse all products</p>
